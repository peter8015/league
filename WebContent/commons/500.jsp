...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" style="color:#013a81;">
 <tr>
  ...
  <tr>
    <td width="31%" align="right"><img src="${ctx}/images/common/sys/500.gif" /></td>
    <td width="32%" align="left" style="font-size:24px; font-weight:bold">&nbsp;&nbsp;系统发生内部错误！</td>
    <td width="37%" align="left" valign="bottom"><a href="#" onclick="logout();">退出系统</a></td>
  </tr>
</table>
</center>
</body>
