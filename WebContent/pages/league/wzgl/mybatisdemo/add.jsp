...
<script type="text/javascript" language="javascript" src="${ctx}/js/common/saveLoad.js"></script>
...
<form id="form1" action="savesyn.do" method="post" enctype="multipart/form-data"> 
  <table width="100%" height="250">  
  <tr>
    <td  align="right">标题：&nbsp;&nbsp;</td>
    <td  align="left"><input id="djgzName" name="djgzName" type="text" size="16"  value=""/><span id="djgzNameValidate" class="mustSpan">*</span></td>
  	<td >类型&nbsp;&nbsp;</td>
  	<td >
  		...
  		</select><span id="djgzTypeValidate" class="mustSpan">*</span>
  	</td> 
  </tr>
  <tr>
    <td  align="right">内容：&nbsp;&nbsp;</td>
    <td colspan="3" align="left"><textarea id="djgzContent" name="djgzContent" cols="85" rows="6"></textarea>
   ...
   <tr>
     ...
     <button type="button" name="save" onclick="formSubmit()" class="button">
								<img src="${ctx}/images/common/button/save.png"/>保&nbsp;&nbsp;存
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" name="reset1" onclick="resetform('form1')" class="button" onclick="document.getElementById('frm').reset();">
